...
window.GUESS_PLAYERS = [
  ...
  },
  {
    ...
    decoys: ["Kevin Keegan", "Marco van Basten", "Ruud Gullit"],
  },
  {
  ...
  },
  {
    ...
    decoys: ["Jack Charlton", "Ray Wilson", "Terry Butcher"],
  },
  {
  ...
  },
  {
    ...
    decoys: ["Uwe Seeler", "Karl-Heinz Rummenigge", "Jürgen Klinsmann"],
  },
  {
    name: "Andrés Iniesta",
    clues: [
  ...
  },
  {
    ...
    decoys: ["Dennis Bergkamp", "Robert Pirès", "Nicolas Anelka"],
  },
  {
  ...
  },
  {
    ...
    decoys: ["Samuel Eto'o", "Salomon Kalou", "Nicolas Anelka"],
  },
  {
    name: "Lionel Messi",
    clues: [
      "Moved from Argentina to Spain as a young teenager after Barcelona agreed to fund treatment for a growth hormone deficiency.",
    ...
    decoys: ["Cristiano Ronaldo", "Neymar", "Luis Suárez"],
  },
  {
    name: "Cristiano Ronaldo",
    clues: [
      "Joined Manchester United from Sporting CP as a teenager in 2003 after impressing in a pre-season friendly.",
      "Won his first Ballon d'Or in 2008 while at Manchester United.",
      "Helped Real Madrid win four Champions League titles in five seasons during the 2010s.",
    ...
    decoys: ["Lionel Messi", "Kylian Mbappé", "Karim Benzema"],
  },
  {
    name: "Zico",
    clues: [
      "Nicknamed the 'White Pelé' for his skill and vision in Brazilian football.",
      "Starred for Flamengo before a later spell in Italy with Udinese.",
      "Part of Brazil's celebrated but ultimately unsuccessful 1982 World Cup squad, considered one of the greatest teams never to win the tournament.",
      "Later helped popularize football at Kashima Antlers in Japan, becoming a hugely influential figure there.",
      "Widely regarded as one of Brazil's greatest players never to win a World Cup.",
    ],
    decoys: ["Sócrates", "Falcão", "Careca"],
  },
  {
    name: "Sócrates",
    clues: [
      "Qualified as a medical doctor while playing professional football in Brazil.",
    ...
    decoys: ["Zico", "Falcão", "Toninho Cerezo"],
  },
  {
    name: "Gianluigi Buffon",
    clues: [
      "Made his Serie A debut for Parma as a 17-year-old goalkeeper in 1995.",
    ...
    decoys: ["Iker Casillas", "Gianluca Pagliuca", "Dino Zoff"],
  },
  {
    name: "Iker Casillas",
    clues: [
    ...
    decoys: ["Gianluigi Buffon", "Víctor Valdés", "David de Gea"],
  },
  {
    name: "David Beckham",
    clues: [
    ...
    decoys: ["Steven Gerrard", "Ryan Giggs", "Paul Scholes"],
  },
  {
    name: "Steven Gerrard",
    clues: [
    ...
    decoys: ["Frank Lampard", "Paul Scholes", "Xabi Alonso"],
  },
  {
    name: "Frank Lampard",
    clues: [
      ...
      "Won the Champions League with Chelsea in 2012, part of a golden generation under multiple managers.",
      "Later returned to manage Chelsea and other clubs after retiring as a player.",
    ],
    decoys: ["Steven Gerrard", "Michael Essien", "Joe Cole"],
  },
  {
    name: "Ryan Giggs",
    clues: [
      "Was born in Cardiff, Wales, and joined Manchester United's youth system as a schoolboy.",
    ...
    decoys: ["Paul Scholes", "David Beckham", "Andrei Kanchelskis"],
  },
  {
    name: "Andrea Pirlo",
    clues: [
      ...
      "Won the World Cup with Italy in 2006, playing a key creative role from midfield.",
    ...
    decoys: ["Xabi Alonso", "Sergio Busquets", "Daniele De Rossi"],
  },
  {
    ...
    clues: [
      ...
      "Widely regarded as one of Italy's greatest-ever defenders.",
    ],
    decoys: ["Alessandro Nesta", "Paolo Maldini", "Marco Materazzi"],
  },
  {
    name: "Luís Figo",
    clues: [
    ...
    decoys: ["Cristiano Ronaldo", "Rui Costa", "Eusébio"],
  },
  {
    name: "Raúl",
    clues: [
    ...
    decoys: ["Fernando Torres", "Fernando Morientes", "David Villa"],
  },
  {
    name: "Alan Shearer",
    clues: [
    ...
    decoys: ["Michael Owen", "Wayne Rooney", "Andy Cole"],
  },
  {
    name: "Neymar",
    clues: [
      "Rose to fame at Santos, the same Brazilian club where Pelé made his name decades earlier.",
    ...
    decoys: ["Ronaldinho", "Kaká", "Gabriel Jesus"],
  },
];
